                    ...
                    <div class="Kegiatan_news">
                        <div class="Kegiatan_single_item fix">
                            ...
                            <div class="Kegiatan_news_text">
                                ...
                                <p>{{ strip_tags(str_limit($bg[0]->text, 30)) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="Kegiatan_news">
                        <div class="Kegiatan_single_item fix">
                            ...
                            <div class="Kegiatan_news_text">
                                ...
                                <p>{{ strip_tags(str_limit($bg[1]->text, 30)) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="Kegiatan_news">
                        <div class="Kegiatan_single_item fix">
                            ...
                            <div class="Kegiatan_news_text">
                                ...
                                <p>{{ strip_tags(str_limit($bg[2]->text, 30)) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="Kegiatan_news">
                        <div class="Kegiatan_single_item fix">
                            ...
                            <div class="Kegiatan_news_text">
                                ...
                                <p>{{ strip_tags(str_limit($bg[3]->text, 30)) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="Kegiatan_news">
                        <div class="Kegiatan_single_item fix">
                            ...
                            <div class="Kegiatan_news_text">
                                ...
                                <p>{{ strip_tags(str_limit($bg[4]->text, 30))    }}</p>
                            </div>
                        </div>
                    </div>
                </div>
