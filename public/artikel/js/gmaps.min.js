...
! function (a, b) {
            ...
            var c = document
                , d = function (b) {
                    ...
                    var D = function (a, b) {
                        ...
                        if (h("gmaps_context_menu")) {
                            ...
                            for (e = 0; l > e; e++) {
                                var m = k[e]
                                    , n = function (c) {
                                        c.prKegiatanDefault(), d[this.id.replace(a + "_", "")].action.apply(j, [b]), j.hideContextMenu()
                                    };
                                google.maps.Kegiatan.clearListeners(m, "click"), google.maps.Kegiatan.addDomListenerOnce(m, "click", n, !1)
                            }
                    ...
                    this.buildContextMenu = function (a, b) {
                        ...
                        google.maps.Kegiatan.addDomListener(f, "mouseout", function (a) {
                    ...
                    var E = function (a, c) {
                        google.maps.Kegiatan.addListener(a, c, function (a) {
                            void 0 == a && (a = this), b[c].apply(this, [a]), j.hideContextMenu()
                        })
                    };
                    google.maps.Kegiatan.addListener(this.map, "zoom_changed", this.hideContextMenu);
                    ...
                    google.maps.Kegiatan.addListener(this.map, "rightclick", function (a) {
                        b.rightclick && b.rightclick.apply(this, [a]), void 0 != window.context_menu[j.el.id].map && j.buildContextMenu("map", a)
                    }), this.refresh = function () {
                        google.maps.Kegiatan.trigger(this.map, "resize")
    ...
    j.prototype.createControl = function (a) {
        ...
        for (var d in a.Kegiatans) ! function (b, c) {
            google.maps.Kegiatan.addDomListener(b, c, function () {
                a.Kegiatans[c].apply(this, [this])
            })
        }(b, d);
        return b.index = 1, b
        ...
        if (i.fences = e, b.infoWindow) {
            ...
            for (var j = ["closeclick", "content_changed", "domready", "position_changed", "zindex_changed"], k = 0; k < j.length; k++) ! function (a, c) {
                b.infoWindow[c] && google.maps.Kegiatan.addListener(a, c, function (a) {
        ...
        }), i.fences && google.maps.Kegiatan.addListener(i, "dragend", function () {
        ...
        return b.setMap(this.map), null != a.auto_show && (c = a.auto_show), b.onAdd = function () {
            ...
            for (var g = 0; g < f.length; g++) ! function (a, b) {
                google.maps.Kegiatan.addDomListener(a, b, function (a) {
                    -1 != navigator.userAgent.toLowerCase().indexOf("msie") && document.all ? (a.cancelBubble = !0, a.returnValue = !1) : a.stopPropagation()
                })
            }(c, f[g]);
            a.click && (d.overlayMouseTarget.appendChild(b.el), google.maps.Kegiatan.addDomListener(b.el, "click", function () {
                a.click.apply(b, [b])
            })), google.maps.Kegiatan.trigger(this, "ready")
        }, b.draw = function () {
        ...
        for (var g = new google.maps.Polyline(f), h = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < h.length; i++) ! function (b, c) {
            a[c] && google.maps.Kegiatan.addListener(b, c, function (b) {
                a[c].apply(this, [b])
            })
        }(g, h[i]);
        ...
        for (var c = new google.maps.Circle(b), d = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], e = 0; e < d.length; e++) ! function (a, c) {
            b[c] && google.maps.Kegiatan.addListener(a, c, function (a) {
                b[c].apply(this, [a])
            })
        }(c, d[e]);
        ...
        for (var g = new google.maps.Polygon(d), h = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < h.length; i++) ! function (a, b) {
            d[b] && google.maps.Kegiatan.addListener(a, b, function (a) {
                d[b].apply(this, [a])
            })
        }(g, h[i]);
        ...
        var b = a.url
            , c = a.Kegiatans;
        delete a.url, delete a.Kegiatans;
        var d = a
            , e = new google.maps.KmlLayer(b, d);
        for (var f in c) ! function (a, b) {
            google.maps.Kegiatan.addListener(a, b, function (a) {
                c[b].apply(this, [a])
            })
        }(e, f);
        ...
        case "bicycling":
            ...
            break;
        case "panoramio":
            this.singleLayers.panoramio = c = new google.maps.panoramio.PanoramioLayer, c.setTag(b.filter), delete b.filter, b.click && google.maps.Kegiatan.addListener(c, "click", function (a) {
    ...
    }, j.custom_Kegiatans = ["marker_added", "marker_removed", "polyline_added", "polyline_removed", "polygon_added", "polygon_removed", "geolocated", "geolocation_failed"], j.on = function (a, b, c) {
        if (-1 == j.custom_Kegiatans.indexOf(a)) return b instanceof j && (b = b.map), google.maps.Kegiatan.addListener(b, a, c);
        var d = {
            handler: c
            , KegiatanName: a
        };
        return b.registered_Kegiatans[a] = b.registered_Kegiatans[a] || [], b.registered_Kegiatans[a].push(d), d
    }, j.off = function (a, b) {
        -1 == j.custom_Kegiatans.indexOf(a) ? (b instanceof j && (b = b.map), google.maps.Kegiatan.clearListeners(b, a)) : b.registered_Kegiatans[a] = []
    }, j.once = function (a, b, c) {
        return -1 == j.custom_Kegiatans.indexOf(a) ? (b instanceof j && (b = b.map), google.maps.Kegiatan.addListenerOnce(b, a, c)) : void 0
    }, j.fire = function (a, b, c) {
        if (-1 == j.custom_Kegiatans.indexOf(a)) google.maps.Kegiatan.trigger(b, a, Array.prototype.slice.apply(arguments).slice(2));
        else if (a in c.registered_Kegiatans)
            for (var d = c.registered_Kegiatans[a], e = 0; e < d.length; e++) ! function (a, b, c) {
                a.apply(b, [c])
            }(d[e].handler, c, b)
